...
- 已完成：TUI 信息架构按 [`plans/2026-04-30-tui-modernization-workbench.md`](../plans/2026-04-30-tui-modernization-workbench.md) 重做为自定义模式；顶层保留默认安装和安全演练，自定义模式内部聚焦检查并安装/更新软件、套件、Skill、MCP 和 CLI。
